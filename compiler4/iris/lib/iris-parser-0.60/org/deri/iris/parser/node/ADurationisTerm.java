...
public final class ADurationisTerm extends PTerm
{
    private TTPreDuration _tPreDuration_;
    ...
    public ADurationisTerm()
    {
        // Constructor
    }

    public ADurationisTerm(
        @SuppressWarnings("hiding") TTPreDuration _tPreDuration_,
    ...
    {
        // Constructor
        setTPreDuration(_tPreDuration_);
    ...
    public Object clone()
    {
        return new ADurationisTerm(
            cloneNode(this._tPreDuration_),
    ...
    {
        ((Analysis) sw).caseADurationisTerm(this);
    }

    public TTPreDuration getTPreDuration()
    {
        return this._tPreDuration_;
    }

    public void setTPreDuration(TTPreDuration node)
    {
        if(this._tPreDuration_ != null)
        {
            this._tPreDuration_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._tPreDuration_ == child)
        {
            this._tPreDuration_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._tPreDuration_ == oldChild)
        {
            setTPreDuration((TTPreDuration) newChild);
            return;
        }
