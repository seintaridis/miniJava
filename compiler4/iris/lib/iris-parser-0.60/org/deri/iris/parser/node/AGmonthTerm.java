...
public final class AGmonthTerm extends PTerm
{
    private TTPreGmonth _tPreGmonth_;
    ...
    public Object clone()
    {
        return new AGmonthTerm(
            cloneNode(this._tPreGmonth_),
    ...
    {
        ((Analysis) sw).caseAGmonthTerm(this);
    }

    public TTPreGmonth getTPreGmonth()
    {
        return this._tPreGmonth_;
    }

    public void setTPreGmonth(TTPreGmonth node)
    {
        if(this._tPreGmonth_ != null)
        {
            this._tPreGmonth_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._tPreGmonth_ == child)
        {
            this._tPreGmonth_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._tPreGmonth_ == oldChild)
        {
            setTPreGmonth((TTPreGmonth) newChild);
            return;
        }
