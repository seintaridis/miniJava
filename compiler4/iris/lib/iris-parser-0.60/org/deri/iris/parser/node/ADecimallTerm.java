...
public final class ADecimallTerm extends PTerm
{
    private TTPreDecimal _tPreDecimal_;
    private TTLpar _tLpar_;
    private TTDec _tDec_;
    private TTRpar _tRpar_;

    public ADecimallTerm()
    {
        // Constructor
    }

    public ADecimallTerm(
        @SuppressWarnings("hiding") TTPreDecimal _tPreDecimal_,
        @SuppressWarnings("hiding") TTLpar _tLpar_,
        @SuppressWarnings("hiding") TTDec _tDec_,
        @SuppressWarnings("hiding") TTRpar _tRpar_)
    {
        // Constructor
        setTPreDecimal(_tPreDecimal_);
    ...
    public Object clone()
    {
        return new ADecimallTerm(
            cloneNode(this._tPreDecimal_),
    ...
    {
        ((Analysis) sw).caseADecimallTerm(this);
    }

    public TTPreDecimal getTPreDecimal()
    {
        return this._tPreDecimal_;
    }

    public void setTPreDecimal(TTPreDecimal node)
    {
        if(this._tPreDecimal_ != null)
        {
            this._tPreDecimal_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._tPreDecimal_ == child)
        {
            this._tPreDecimal_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._tPreDecimal_ == oldChild)
        {
            setTPreDecimal((TTPreDecimal) newChild);
            return;
        }
