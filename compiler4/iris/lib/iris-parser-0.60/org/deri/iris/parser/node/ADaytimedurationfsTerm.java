...
public final class ADaytimedurationfsTerm extends PTerm
{
    ...
    public Object clone()
    {
        return new ADaytimedurationfsTerm(
    ...
    {
        ((Analysis) sw).caseADaytimedurationfsTerm(this);
    }
