...
public final class ADatetimemstzTerm extends PTerm
{
    ...
    public ADatetimemstzTerm(
        ...
        @SuppressWarnings("hiding") TTComma _c8_,
    ...
    {
        ((Analysis) sw).caseADatetimemstzTerm(this);
    }
    ...
    public TTComma getC8()
    {
        return this._c8_;
    }

    public void setC8(TTComma node)
    {
        if(this._c8_ != null)
        {
            this._c8_.parent(null);
        }
    ...
    void replaceChild(@SuppressWarnings("unused") Node oldChild, @SuppressWarnings("unused") Node newChild)
    {
        ...
        if(this._c8_ == oldChild)
        {
            setC8((TTComma) newChild);
            return;
        }
