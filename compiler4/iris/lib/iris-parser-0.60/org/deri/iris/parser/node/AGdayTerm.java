...
public final class AGdayTerm extends PTerm
{
    private TTPreGday _tPreGday_;
    ...
    public Object clone()
    {
        return new AGdayTerm(
            cloneNode(this._tPreGday_),
    ...
    {
        ((Analysis) sw).caseAGdayTerm(this);
    }

    public TTPreGday getTPreGday()
    {
        return this._tPreGday_;
    }

    public void setTPreGday(TTPreGday node)
    {
        if(this._tPreGday_ != null)
        {
            this._tPreGday_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._tPreGday_ == child)
        {
            this._tPreGday_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._tPreGday_ == oldChild)
        {
            setTPreGday((TTPreGday) newChild);
            return;
        }
