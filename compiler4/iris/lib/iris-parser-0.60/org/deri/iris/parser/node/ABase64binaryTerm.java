...
public final class ABase64binaryTerm extends PTerm
{
    private TTPreBase64 _tPreBase64_;
    private TTLpar _tLpar_;
    private TTStr _tStr_;
    private TTRpar _tRpar_;

    public ABase64binaryTerm()
    {
        // Constructor
    }

    public ABase64binaryTerm(
        @SuppressWarnings("hiding") TTPreBase64 _tPreBase64_,
        @SuppressWarnings("hiding") TTLpar _tLpar_,
        @SuppressWarnings("hiding") TTStr _tStr_,
        @SuppressWarnings("hiding") TTRpar _tRpar_)
    {
        // Constructor
        setTPreBase64(_tPreBase64_);
    ...
    public Object clone()
    {
        return new ABase64binaryTerm(
            cloneNode(this._tPreBase64_),
    ...
    {
        ((Analysis) sw).caseABase64binaryTerm(this);
    }

    public TTPreBase64 getTPreBase64()
    {
        return this._tPreBase64_;
    }

    public void setTPreBase64(TTPreBase64 node)
    {
        if(this._tPreBase64_ != null)
        {
            this._tPreBase64_.parent(null);
        }
    ...
    {
        // Remove child
        if(this._tPreBase64_ == child)
        {
            this._tPreBase64_ = null;
            return;
        }
    ...
    {
        // Replace child
        if(this._tPreBase64_ == oldChild)
        {
            setTPreBase64((TTPreBase64) newChild);
            return;
        }
